...
import { setCurrentVehicle } from "./currentVehicleState";
              ...
              <div className="col-md-6 d-flex align-items-center">
                <div className="card-body">
                  ...
                  <p className="text-center mb-5">
                    Welcome Back! Please enter your vehicle's number plate to
                    track your towed vehicle
                  </p>
                  {/* <form>
